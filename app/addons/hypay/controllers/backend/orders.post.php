...
/**
 * Payment info holds finished strings in whatever language the customer checked
 * out in, so the J5 lines are composed again from ?:hypay_transactions in the
 * reader's language, and the "J5 hold" line is dropped because the panel further
 * down the page already prints the hold in full.
 *
